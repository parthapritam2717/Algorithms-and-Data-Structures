...
int countInversion(vl array1,ll n){
    ...
    for(ll i=1;i<n;++i){
        ...
        int d=distance(it,data.end());
        //cout<<"inversion for "<<i<<"="<<d<<endl;
        inversion+=d;
    }
    return inversion;
}
...
int main(){
            ...
            // this method will use the SET stl of cpp which uses self balancing binary search tree which gives a time complexity of nlogn.
            cout<<"The number of inversions="<<countInversion(list1,n);
